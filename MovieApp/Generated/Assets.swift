...
internal enum Asset {
  ...
  internal static let caitlynArcaneWickellia = ImageAsset(name: "Caitlyn - Arcane, Wickellia")
  internal static let spaceArtWallpapers = ImageAsset(name: "Space art wallpapers")
  internal static let colorBackground = ColorAsset(name: "color_background")
  ...
  internal static let calendarUnselected = ImageAsset(name: "calendar_unselected")
  ...
  internal static let mosqueUnselected = ImageAsset(name: "mosque_unselected")
  internal static let number = ImageAsset(name: "number")
  internal static let numberUnselected = ImageAsset(name: "number_unselected")
